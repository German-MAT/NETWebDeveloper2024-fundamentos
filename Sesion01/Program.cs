...
//Console.WriteLine("La siguiente linea, sirve para un valor vacio (NO NULO)");
...
//Console.WriteLine("Formato con d " + fechaNacimiento.ToString("d"));
//Console.WriteLine("Formato pesonalizado " + fechaNacimiento.ToString("dd MMM yyyy"));
...
////Console.WriteLine("\nIngrese un valor de fecha por favor");
...
Console.WriteLine($"Valor formato 1: {fechaActual.ToString("G", referencia01)}");
Console.WriteLine($"Valor formato 2: {fechaActual.ToString("G", referencia02)}");

Console.WriteLine("Fin del programa :-)");


////Concatenacion Normal
//Console.WriteLine("Formato largo: " + fechaNacimiento.ToString("D"));
//Console.WriteLine("Formato corto: " + fechaNacimiento.ToString("d"));
//Console.WriteLine("Mes y dia: " + fechaNacimiento.ToString("M"));
//Console.WriteLine("Año, mes y dia: " + fechaNacimiento.ToString("O"));
//Console.WriteLine("Año, mes: " + fechaNacimiento.ToString("Y"));

////Concatenacion string format
//Console.WriteLine(string.Format("\nFormato largo: {0}", fechaNacimiento.ToString("D")));
//Console.WriteLine(string.Format("Formato corto: {0}", fechaNacimiento.ToString("d")));
//Console.WriteLine(string.Format("Mes y dia: {0}", fechaNacimiento.ToString("M")));
//Console.WriteLine(string.Format("Año, mes y dia: {0}", fechaNacimiento.ToString("O")));
//Console.WriteLine(string.Format("Año, mes: {0}", fechaNacimiento.ToString("Y")));

////Concatenacion string interpolation
//Console.WriteLine($"\nFormato largo: {fechaNacimiento:D}");
//Console.WriteLine($"Formato corto: {fechaNacimiento:d}");
//Console.WriteLine($"Mes y dia: {fechaNacimiento:M}");
//Console.WriteLine($"Año, mes y dia: {fechaNacimiento:O}");
//Console.WriteLine($"Año, mes: {fechaNacimiento:Y}");